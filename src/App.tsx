...
function getStatus() {
  ...
  if (d===0) return (m>=1020 && m<1380) ? {open:true,  next:'Cierra a las 23:00'} : {open:false, next:'Abre a las 17:00'}
  if (d===1 || d===2) return (m>=540 && m<1380) ? {open:true,  next:'Cierra a las 23:00'} : {open:false, next:'Abre a las 09:00'}
  if (d===3 || d===4) return m>=540 ? {open:true,  next:'Cierra a las 00:00'} : {open:false, next:'Abre a las 09:00'}
  return               m>=540  ? {open:true,  next:'Cierra a la 01:00 AM'} : {open:false, next:'Abre a las 09:00'}
}
        ...
        <div style={{ position:'relative', maxWidth:'1200px', margin:'0 auto' }}>
          ...
          <div style={{ display:'grid', gridTemplateColumns:'repeat(auto-fit,minmax(320px,1fr))', gap:'16px' }}>
            ...
            <div style={{ borderRadius:'24px', padding:'36px', background:C.surface, border:`1px solid ${C.border}` }}>
              ...
              {[['Lunes y Martes','09:00 – 23:00'],['Miércoles y Jueves','09:00 – 00:00'],['Viernes y Sábado','09:00 – 01:00 AM'],['Domingo','17:00 – 23:00']].map(([d,h],i,arr)=>(
